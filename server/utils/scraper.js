...
async function scrapeVTUResult(usn) {
    try {
        ...
        const mockResult = {
            ...
            subjects: [
                { code: "21CS61", name: "Software Engineering", internalMarks: 40, externalMarks: 50, totalMarks: 90, grade: "S", result: "P", credits: 4 },
                { code: "21CS62", name: "Full Stack Development", internalMarks: 38, externalMarks: 45, totalMarks: 83, grade: "A", result: "P", credits: 4 },
                { code: "21CS63", name: "Computer Networks", internalMarks: 35, externalMarks: 40, totalMarks: 75, grade: "B", result: "P", credits: 3 },
                { code: "21CS64", name: "Operating Systems", internalMarks: 30, externalMarks: 35, totalMarks: 65, grade: "C", result: "P", credits: 3 },
            ],
            totalMarks: 313,
            percentage: 78.25,
            sgpa: 8.5,
